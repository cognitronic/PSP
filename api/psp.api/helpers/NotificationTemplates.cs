...
namespace psp.api.helpers
{
    public class NotificationTemplates
    {
        ...
        public static string CourtesyCouponHtmlStart(string email)
        {
            ...
            var cc = new CouponCodeRepository().GetByCouponByStatus("complimentary", false).First<CouponCode>(); //new CouponCodeServices().GetCouponCodeByCouponID(ConfigurationManager.AppSettings["BIRTHDAYEMAILCOUPONID"]);
            sb.Append("</head>");
            sb.Append("<body>");
            sb.Append("<a href='");
            sb.Append(ConfigurationManager.AppSettings["BIRTHDAYCOUPONURL"]);
            ...
            sb.Append(cc.codetext);
            sb.Append("'><img src='");
            sb.Append(ConfigurationManager.AppSettings["COURTESYCOUPONNOTIFICATIONIMAGE"]);
        ...
        public static string CourtesyCouponHtmlEnd()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("</body>");
            sb.Append("</html>");
